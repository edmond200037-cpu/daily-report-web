...
const row = (id: string, name: string, tradeTypeId?: string): NamedMemory => ({ id, name, normalizedName: name.trim().toLowerCase(), usageCount: 0, finalizedUsageCount: 0, lastUsedAt: null, createdAt: '', updatedAt: '', status: 'confirmed', tradeTypeId });
describe('工種管理搜尋與滑動', () => {
